...
#waccountWrap{width:100%;min-height:100%;background:#f9f9f9;font-family:Roboto, 'Noto Sans KR', sans-serif;-webkit-font-smoothing:antialiased}
.waccount-wrap{width:100%;}
#waccountContainer{padding:35px 20px;color:#4a4a4a;}
@media screen and (min-width: 960px) {
	#waccountContainer{width:400px;margin:0 auto;padding:50px 0;}
}
.waccount-wrap h3{margin-bottom:15px;font-size:20px;line-height:24px;font-weight:normal;}
.waccount-wrap h3 em{color:#23dbab}
.waccount-wrap h4{margin-bottom:5px;font-size:13px;line-height:20px;color:#23dbab;letter-spacing:-0.5px}
.waccount-wrap .step-info{margin-bottom:20px;display:table;width:100%;}
.waccount-wrap .step-info li{display:table-cell;width:33.333333%;padding-right:1px;vertical-align:middle;}
.waccount-wrap .step-info li em{display:block;width:100%;height:4px;background:#ccc;}
.waccount-wrap .step-info li.active em{background:#23dbab}
.waccount-wrap h5{margin-bottom:5px;padding-top:10px;font-size:15px;line-height:20px;font-weight:normal;}
.waccount-wrap .sub-text{margin-bottom:5px;font-size:12px;line-height:14px;color:#4a4a4a;}
.waccount-wrap .comment{margin-bottom:10px;font-size:11px;line-height:14px;color:#4a4a4a;}
.waccount-wrap a.line-link{display:block;margin-bottom:10px;font-size:11px;line-height:14px;color:#4a4a4a;text-decoration:underline}
.waccount-wrap .box-notice{margin-bottom:10px;padding:15px;font-size:12px;line-height:16px;color:#4a4a4a;background:#e7e7e7}
.waccount-wrap .btn-darkgray{display:block;width:100%;height:44px;font-size:13px;line-height:46px;text-align:center;color:#fff;background:#8c8881;border:none;box-sizing:border-box}
.waccount-wrap .btn-darkgray2{display:block;width:100%;padding:10px 0;font-size:13px;line-height:20px;text-align:center;color:#fff;background:#8c8881;border:none;box-sizing:border-box}
.waccount-wrap .btn-mint{display:block;width:100%;height:46px;font-size:13px;line-height:44px;text-align:center;color:#fff;background:#23dbab;border:none;box-sizing:border-box}
.waccount-wrap .btn-mint2{display:block;width:100%;padding:10px 0;font-size:13px;line-height:20px;text-align:center;color:#fff;background:#23dbab;border:none;box-sizing:border-box}
.waccount-wrap .btn-linemint{display:block;width:100%;height:46px;font-size:13px;line-height:44px;text-align:center;color:#23dbab;background:none;border:1px solid #23dbab;box-sizing:border-box}
.waccount-wrap button.error{border:1px solid #d0021b}
.waccount-wrap .w110{width:110px}
.waccount-wrap em.line{display:block;margin:40px 0;width:100%;height:1px;background:#ddd}


.input-group{display:table;width:100%;height:46px;padding:0;}
.input-text{-webkit-appearance:none;border-radius:0}
.input-area{position:relative;}
.input-group .input-area{display:table-cell;width:auto;height:46px;margin:0;padding:0 5px 0 0;vertical-align:top}
.input-group .btn-area{display:table-cell;width:110px;height:46px;padding:0;}
.input-area.disabled .input-text, .input-text:disabled{background:#e7e7e7}
.input-area em.timeout{display:none;position:absolute;right:15px;top:15px;text-align:right;font-size:13px;color:#23dbab;z-index:10}
.input-div2{width:100%;padding:0;}
...
.btn-div2{width:100%;padding:0;}
.btn-div2:after{content:"";clear:both;display:block;}
.btn-div2 li:first-child{float:left;width:49%;padding:0;}
.btn-div2 li:last-child{float:right;width:49%;padding:0;}

.file-list{width:100%;}
.file-list li{position:relative;width:100%;margin-bottom:10px;}
.file-list li .file-block{display:block;width:100%;height:46px;padding:0 37px 0 15px;line-height:44px;font-size:13px;background:#fff;border:1px solid #e4e4e4;box-sizing:border-box;overflow:hidden;white-space:nowrap;text-overflow:ellipsis}
.file-list li .file-block.disabled{background:#e7e7e7}
.file-list li .btn-close{position:absolute;right:15px;top:13px;display:block;padding:0;width:20px;height:20px;background:url(/resources/static/img/common/icon_gray_close.png) no-repeat 0 0;background-size:cover;border:none;}
.file-list li .file-block .status{display:inline-block;padding:0 10px;margin-right:5px;height:20px;line-height:20px;font-size:12px;color:#fff;background:#23dbab;border:none;border-radius:10px;}
.file-list li .file-block .status.ing{background:#a29584}
.file-list li .file-block .status.fail{background:#d0021b}


.radio-wrap{padding:10px;}
.radio-wrap label{color:#4a4a4a;}
.radio-wrap input[type=radio]{position:absolute;left:-100000px;top:auto;width:1px;height:1px;overflow:hidden;}
.radio-wrap input[type=radio]:checked+label{color:#23dbab}
.radio-wrap .radio-list{margin-bottom:15px;}
.radio-list dt{padding-left:25px;font-size:15px;font-weight:500;line-height:20px;background:url(/resources/static/img/common/icon_none_check.png) no-repeat 0 0;background-size:20px 20px}
.radio-wrap input[type=radio]:checked+label .radio-list dt{background-image:url(/resources/static/img/common/icon_mint_check.png)}
.radio-list dd{padding-left:25px;font-size:13px;line-height:18px;}

.certinfo-wrap{display:none;margin-bottom:15px;padding:15px;background:#fff;border:1px solid #e4e4e4;}
.certinfo-wrap p{margin-bottom:5px;font-size:13px;line-height:16px;}
.certinfo-wrap p.title{font-weight:500;}

.certinfo-wrap .info-box{margin-bottom:10px;padding:15px;border:1px solid #e4e4e4;background:#fff;}
.certinfo-wrap .info-box .status{display:inline-block;padding:0 10px;margin:0 5px 10px 0;height:20px;line-height:20px;font-size:12px;color:#fff;background:#23dbab;border:none;border-radius:10px;}
.certinfo-wrap .info-box.fail .status{background:#d0021b}
.certinfo-wrap .info-box p{font-weight:500;}
.certinfo-wrap .info-box.fail p{color:#d0021b}

.agree-list{width:100%;}
.agree-list li{display:table;width:100%;margin-bottom:5px;}
.agree-list li label{display:table;width:100%;}
.agree-list li .input-area{display:table-cell;width:25px;vertical-align:top;}
.agree-list li .input-rdcheck{margin:5px;width:18px;height:18px;background:url(/resources/static/img/common/icon_none_check.png) no-repeat 0 0;background-size:18px 18px;-webkit-appearance:none;border:none;outline:none}
.agree-list li .input-rdcheck:checked{background-image:url(/resources/static/img/common/icon_mint_check.png)}
.agree-list li p.text{display:table-cell;width:auto;font-size:13px;vertical-align:middle;}
.agree-list li dl{display:table-cell;width:auto;border:1px solid #e7e7e7;vertical-align:top;}
.agree-list li dl dt{width:100%;}
.agree-list li dl .btn-terms{display:block;width:100%;position:relative;top:0;left:0;padding:0 20px;height:34px;line-height:34px;text-align:left;font-size:12px;background:#e7e7e7;border:none;box-sizing:border-box}
.agree-list li dl .btn-terms em{position:absolute;right:10px;top:0px;font-size:11px;}
.agree-list li dl dd{display:none;padding:15px;height:100px;font-size:12px;background:#fff;overflow-y:scroll;}
.agree-list li dl.open dd{display:block}
.agree-list li dl dd *{font-size:12px !important;line-height:18px;padding:0;}
.agree-list li dl dd table{width:100%;border-collapse:collapse;table-layout:fixed;}
.agree-list li dl dd table th, .agree-list li dl dd table td{padding:5px;border:1px solid #ddd;}
.agree-list li .terms-title{display:table-cell;width:auto;}
.agree-list li .terms-title p{display:block;width:100%;position:relative;padding:0 20px;height:34px;line-height:34px;text-align:left;font-size:12px;background:#e7e7e7;border:none;box-sizing:border-box}

.daum-address-wrap{width:100%;background:#fff;}
.daum-address-wrap .btn-wrap{padding:10px 0;text-align:center;}
#daumAddressCon{width:100%;}
#__daum__layer_1{width:100% !important;}
@media screen and (min-width: 960px) {
.daum-address-wrap{width:500px;margin:50px auto;background:#fff}
}


.event-link{width:100%;border:1px solid #e4e4e4;}
.event-link em.img{width:100%;}
.event-link em.img img{width:100%;}
.event-link p{padding:15px;font-size:13px;color:#4a4a4a;background:#fff;}
...
.error-text{margin-bottom:12px;font-size:11px;line-height:14px;color:#d0021b;display:none;}
...
.btn-pd-mint, a.btn-pd-mint, button.btn-pd-mint, input.btn-pd-mint{display:inline-block;padding:0 15px;height:42px;line-height:42px;font-size:16px;background:#50e3c2;color:#fff;border:none;cursor:pointer;-webkit-appearance: none;}
...
.btn-db-mint, a.btn-db-mint, button.btn-db-mint{display:block;width:100%;padding:0;height:54px;line-height:54px;font-size:20px;background:#50e3c2;color:#fff;border:none;cursor:pointer;text-align:center;}
...
.btn-dbline-white, a.btn-dbline-white, button.btn-dbline-white{display:block;width:100%;padding:0;height:52px;line-height:52px;font-size:18px;background:none;color:#fff;border:1px solid #fff;cursor:pointer;box-sizing:border-box !important;text-align:center;}
...
.common-card dl.progressbar-wrap dt span{display:block;height:10px;background:#50e3c2}
...
.common-card .card-info-section .card-category .category2{float:right;padding-right:20px;display:block;width:38%;text-align:right;font-size:11px;color:#50e3c2;letter-spacing:-1px}
...
/*******POPUP********/
.black-bg-wrap{position:fixed;top:0;left:0;width:100%;height:100%;background:#000;opacity:0.6;z-index:1001}
.lypop-fixed{position:fixed;top:0;left:0;width:100%;height:100%;z-index:110001;display:none;overflow-y:auto}
						...
						<form id="saveForm">
							...
							<h5>주소</h5>
		       				...
		       				<div class="btn-wrap post-btn">
		       					<button type="button" class="btn-darkgray w110" onclick="Wpost();">우편번호 검색</button>
		       				</div>
		       				<div class="input-area">
			              		<input type="text" id="location1" name="location1" class="input-text" placeholder="주민등록상의 주소" readonly/>
			              		<input type="text" id="location2" name="location2" class="input-text" placeholder="상세 주소" />
							...
							<h5>실명확인증표 등록</h5>
				       		...
				       		<p class="comment">와디즈에서 청약을 하기 위해서는 금융실명법에 따라 실명확인이 필요합니다. 와디즈는 금융위원회에 정식 등록된 온라인소액투자중개업자로 실명확인을 진행하오니 안심하고 등록해주세요.</p>
							<!-- [E] 실명확인증표 등록 -->
