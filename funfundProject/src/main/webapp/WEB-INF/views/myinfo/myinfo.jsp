...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	...
	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
		...
		<!-- <table class="mtablestart">
				<tr class="mtable" align="center">
					<td class="mtd"><img class="mphoto" src="images/육찡.jpg">사진 값이 들어갈 곳 </td>
				</tr>
			</table> -->
					<div class="row">
						<div class="col-lg-3 col-xs-6" align="center"><img class="img-circle img-responsive" src="images/육찡.jpg" style="max-width:150px;max-height:150px;"><!-- 사진 값이 들어갈 곳  --></div>
						<div class="col-lg-3 col-xs-6 mrow mname" align="center" style="max-width:150px;max-height:150px;">육성재<!-- 회원 이름이 들어갈 곳 --></div>
						<div class="col-lg-3 col-xs-6 mrow" align="center" style="max-width:250px;max-height:150px;"><label class="mgrade">개인 일반 회원 <!-- 회원 등급이 들어갈 곳  --></label></div>
						<div class="col-lg-3 col-xs-6 mrow" align="center" style="max-width:500px;max-height:150px;"><input type="button" class="mbtn1" value="투자서비스 회원이 되세요"></div>
					</div>
