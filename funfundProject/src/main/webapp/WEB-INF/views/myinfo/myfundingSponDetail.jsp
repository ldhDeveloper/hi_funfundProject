					...
					<div class="panel-group">
						<div class="well">
							<div class="alert alert-info">
  								<h5>* 참여프로젝트를 클릭하시면 참여상세 내역에서 결제방법/배송지/배송메모 등을 보실 수 있습니다.</h5>
							</div>
  							...
  							<div class="tableStart">
      							...
      							<label id="delivery">참여한 프로젝트 정보</label><input class="joinBtn" type="submit" value="참여취소">
  									...
  									<table class="table">
    										...
    										<tbody class="paddingGo">
      											<tr class="joinProjecttr">
        											<td class="jptd">${ myfundingSpon.fund_no }</td>
        											<td class="jptd"><b class="state" id="progress"></b>&nbsp;&nbsp;&nbsp;${ myfundingSpon.pname }</td>
        											<td class="jptd">${ myfundingSpon.pedate }</td>
        											<td class="jptd">${ myfundingSpon.sumcost }원</td>
        											<td class="jptd">${ myfundingSpon.funstatus }</td>
      											</tr>    										      											      											
    										</tbody>
  										</table>
  										...
  										<script type="text/javascript">
											$(function(){
												var d = new Date();
												var pedate = new Date("<c:out value='${myfundingSpon.pedate}'/>");
  										...
  										<div class="choiceReward">
  											...
  											<p>&nbsp;&nbsp;&nbsp;${ myfundingSpon.pname }</p>
  											<p id="fundCount">&nbsp;&nbsp;&nbsp;${ myfundingSpon.fundcount }개 / ${ myfundingSpon.mcost }원</p>
  										</div>
  									...
  									<table class="table">
    										...
    										<tbody class="paddingGo">
      											<tr class="paymenttr">
        											<td class="paytd">${ myfundingSpon.payment }</td>
        											<td class="paytd">${ myfundingSpon.evidence }</td>
        											<td class="paytd">${ myfundingSpon.funstatus }</td>
      											</tr>    										      											      											
    										</tbody>
  										</table>
  										...
  										<input type="hidden" name="fund_no" value="${ myfundingSpon.fund_no }">
  										...
  										<table class="table">
  											<tbody class="paddingGo">
      											<tr class="mdtrs">
        											...
        											<td class="mdtdv"><b id="recnameb" class="">${ myfundingSpon.recname }</b><input class="" id="recnamei" name="recname" placeholder="변경할 이름을 입력하세요." value="" style="display:none;border:none;" required autofocus></td>
      											</tr>
      											
      											<tr class="mdtr">
        											<td class="mdtd">연&nbsp;&nbsp;&nbsp;락&nbsp;&nbsp;&nbsp;처</td>
        											<td class="mdtdv"><b id="rephoneb" class="">${ myfundingSpon.rephone }</b><input class="" id="rephonei" name="rephone" placeholder="변경할 연락처를 입력하세요." value="" style="display:none;border:none;" required></td>
      											</tr>
  										...
  										<script type="text/javascript">
  											$(function(){
  												...
  												var add ='<c:out value="${myfundingSpon.deladdress}"/>';
