    						...
    						<div class="panelStart1 panel panel-info">    						
      							...
      							<div class="dlistStart container">
			  						<ul class="DStart nav nav-pills">
			    						<li class="sideDlist"><a class="sdlist">모두보기</a></li>
			    						<li class="mainDlist"><a class="mdlist" href="inwrite.it">작성중</a></li>
			    						<li class="sideDlist"><a class="sdlist" href="ongoing.it">진행중</a></li>
			    						<li class="sideDlist"><a class="sdlist" href="deadline.it">후원종료</a></li>
								  	</ul>
