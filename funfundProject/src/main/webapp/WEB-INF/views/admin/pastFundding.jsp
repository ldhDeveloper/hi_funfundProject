...
<body>
  ...
  <ul class="nav nav-tabs">
	  ...
	  <li class="active"><a href="pastFundding.am">지난입금내역</a></li>
 </ul>
 <div class="row rowmargin">
 <span class="inlinedrop">
 	<div class="dropdown">
	  <button id="yearbtn" class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown">년도
	  <span class="caret"></span></button>
	  <ul id="yeardrop" class="dropdown-menu">
	    <li><a href="#">2013</a></li>
	    <li><a href="#">2014</a></li>
	    <li><a href="#">2015</a></li>
	    <li><a href="#">2016</a></li>
...
<span class="inlinedrop">
<div class="dropdown">
	  <button id="monthbtn" class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown">월
	  <span class="caret"></span></button>
	  <ul id="monthdrop" class="dropdown-menu">
	  	<li><a href="#">전체보기</a></li>
	    <li><a href="#">1</a></li>
	    <li><a href="#">2</a></li>
	    <li><a href="#">3</a></li>
...
<span>월</span>&nbsp;&nbsp;
<span><input class="btn btn-primary" type="button" id="periodSearch" value="조회하기" onclick="return itemsearch();" /></span>
  ...
  <script>
  	...
  	function itemsearch(){
  		if($("#yearbtn").val() != null && $("#monthbtn").val() != null){
  			$.ajax({
  				url : "endeditemsearch.am",
  				type : "post",
  				data : {"year" : $("#yearbtn").val(), "month" : $("#monthbtn").val()},
  				success : function(data){
  					...
  					for(var i = 0; i < data.length; i++){
  						...
  						var secondprice = data[i].secondprice;
  						var currentprice = firstprice+secondprice;
  						html += "<tr><td>" + data[i].pro_no + "</td>";
  						html += "<td>" + data[i].pname + "</td>";
  						html += "<td id='ipersent" + i + "'>" + persent + "</td>" ;
  						html += "<td>" + data[i].pstatus + "</td>";
  						html += "<td>" + data[i].billstatus + "</td>";
  						html += "<td>" + data[i].pedate + "</td>";
  						html += "<td>" + data[i].fundamount + "</td>";
  						html += "<td id='currentprice" + i + "'>" + currentprice + "</td>" ;
  						html += "<td><input type='button' class='btn btn-primary' value='프로젝트보기' onclick='popen(" + data[i].pro_no + ")'></td>";
  						html += "<td><input type='button' class='btn btn-success' value='정보상세보기' onclick='pDetailOpen(" + i + ")'></td></tr>";
  						html += "<tr id='infoDetailForm" + i + "' style='display:none;'>"; 
  						html += "<td colspan='10'><div class='row tmargin'>";
  						html += "<div class='col-xs-12 col-sm-12 col-md-2 col-lg-2'><h6>상호명</h6></div>";
  						html += "<div class='col-xs-12 col-sm-12 col-md-4 col-lg-4'><input type='text' class='form-control' value=" + data[i].cname + " readonly></div>";
  						html += "<div class='col-xs-12 col-sm-12 col-md-2 col-lg-2'><h6>회사전화</h6></div>";
  						html += "<div class='col-xs-12 col-sm-12 col-md-4 col-lg-4'><input type='text' class='form-control' value=" + data[i].cs_phone + " readonly></div></div>";
  						html += "<div class='row tmargin'>";
  						html += "<div class='col-xs-12 col-sm-12 col-md-2 col-lg-2'><h6>회사메일</h6></div>";
  						html += "<div class='col-xs-12 col-sm-12 col-md-4 col-lg-4'><input type='text' class='form-control' value=" + data[i].cs_email + " readonly></div>";
  						html += "<div class='col-xs-12 col-sm-12 col-md-2 col-lg-2'><h6>예금주</h6></div>";
  						html += "<div class='col-xs-12 col-sm-12 col-md-4 col-lg-4'><input type='text' class='form-control' value=" + data[i].accpnm + " readonly></div></div>";
  						html += "<div class='row tmargin'>";
  						html += "<div class='col-xs-12 col-sm-12 col-md-2 col-lg-2'><h6>은행명</h6></div>";
  						html += "<div class='col-xs-12 col-sm-12 col-md-4 col-lg-4'><input type='text' class='form-control' value=" + data[i].bankcode + " readonly></div>";
  						html += "<div class='col-xs-12 col-sm-12 col-md-2 col-lg-2'><h6>계좌번호</h6></div>";
  						html += "<div class='col-xs-12 col-sm-12 col-md-4 col-lg-4'><input type='text' class='form-control' value=" + data[i].accnum + " readonly></div></div>";
  						html += "<div class='row tmargin'>";
  						html += "<div class='col-xs-12 col-sm-12 col-md-2 col-lg-2'><h6>1차입금일</h6></div>";
  						html += "<div class='col-xs-12 col-sm-12 col-md-4 col-lg-4'><input id='firstdeposit" + i + "' type='date' class='form-control' value=" + data[i].firstdeposit + " readonly></div>";
  						html += "<div class='col-xs-12 col-sm-12 col-md-2 col-lg-2'><h6>1차금액</h6></div>";
